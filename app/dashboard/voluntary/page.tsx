...
export default async function MembersPage() {
  ...
  const { data: rows, error } = await supabase
    .from("members")
    .select("id, firstname, lastname, email, committee, privilege_type, created_by, created_at, password_set_at, is_membership_active, membership_active_until, is_banned")
